<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddFertilizerRecipe.aspx.cs" Inherits="Sapling_System.Pages.AddFertilizerRecipe" %>
        ...
        <div class="col-border1">
            ...
            <div class="table" align="center">
                ...
                <table class="tblPlaceOrder">
                    ...
                    <tr>
                         <td>Mono Potassium Phosphate</td>
                        <td>
                            <asp:TextBox TextMode="Number" min="0" Width="55px" runat="server"></asp:TextBox>
                        </td>
                        <td>
            ...
            <div class="buttons">
                <div class="bottom-right">
                    <asp:LinkButton ID="btnAddRecipe" CssClass="btn" runat="server" OnClick="btnAddRecipe_Click">
                        <span class="glyphicon glyphicon-plus" title="Add Recipe" aria-hidden="true"></span> Add Recipe
                    </asp:LinkButton>
                </div>
            </div>
        </div>
