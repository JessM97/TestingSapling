<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="WriteOffStock.aspx.cs" Inherits="Sapling_System.Pages.WriteOffStock" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
     <div class="columns">
        <div class="col">
            <h3>Write Off Stock:</h3>
            <br />
            <label class="lbl">Stock Item:</label>
            <br />
            <asp:TextBox ID="txtStockItem" CssClass="txt" Text="Pots" Enabled="false" runat="server"></asp:TextBox>          
            <br />
            <br />
