<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddTempWorker.aspx.cs" Inherits="Sapling_System.Pages.AddTempWorker" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    <div class="ribbon">
        <h3>Enter Temporary Worker Details:</h3>
    </div>
    <div class="table">
