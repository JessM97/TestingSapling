            ...
            <span class="glyphicon glyphicon-trash" title="Write Off Plant" aria-hidden="true"></span> Write Off Plants
                ...
                <div class="columns">
                    <div class="col">
                        ...
                        <br />
                        <asp:TextBox ID="txtPlantBatchID" Enabled="false" CssClass="txt" runat="server" Text="2343"></asp:TextBox>
                        <br />
                        <br />
                        <label class="lbl">Plant Name:</label>
                        <br />
                        <select id="plantNameSelect" class="style-select" enabled="false">
                        ...
                        <br />
                        <asp:TextBox ID="txtPlantedType" CssClass="txt" runat="server" Enabled="false" Text="Seeds"></asp:TextBox>
                        <br />
                        <br />
                    ...
                    <div class="col">
                        ...
                        <br />
                        <asp:TextBox ID="txtPBStatus" CssClass="txt" Enabled="false" runat="server" Text="Planted"></asp:TextBox>
                        <br />
                        <br />
                        <label class="lbl">Plant Stage:</label>
                        <br />
                        <asp:TextBox ID="txtPBStage" CssClass="txt" Enabled="false" runat="server"  Text="Germinated"></asp:TextBox>
                        <br />
                        <br />
                        <label class="lbl">Current Quantity:</label>
                        <br />
                        <asp:TextBox ID="txtCurrentQ" CssClass="txt" Enabled="false" TextMode="Number" min='0' runat="server"  Text="1500"></asp:TextBox>
                        <br />
                        <br />
