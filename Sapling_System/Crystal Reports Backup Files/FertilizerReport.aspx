<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="FertilizerReport.aspx.cs" Inherits="Sapling_System.Pages.FertilizerReport" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="tabs" ForeColor="Black" CssTheme="None">
        <ajaxToolkit:TabPanel runat="server" HeaderText="Report Specifics" ID="tabReportSpecifics" CssClass="tabsIndiv">
            <ContentTemplate>
                <div class="col">
                    <h3>Fertilizer Report:</h3>
                </div>

                <div class="rprtDescr">
                    <label class="lblRprtDescr">This report will contain information about the fertilizer(s) used on the specified plant batch. It will give an indication of the fertilizer usage, the consequent growth increments, and an indication of the best fertilizer.</label>
                </div> 

                <div class="columns">
                    <div class="col">
                        <h4>Select plant batch to generate the fertilizer report for:</h4>
                    </div>
