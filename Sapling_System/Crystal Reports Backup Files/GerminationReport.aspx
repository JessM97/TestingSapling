<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="GerminationReport.aspx.cs" Inherits="Sapling_System.Pages.GerminationReport" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="tabs" ForeColor="Black" CssTheme="None">
        <ajaxToolkit:TabPanel runat="server" HeaderText="Report Specifics" ID="tabReportSpecifics" CssClass="tabsIndiv">
            <ContentTemplate>
                <div class="col">
                    <h3>Germination Report:</h3>
                </div>

                <div class="rprtDescr">
                    <label class="lblRprtDescr">This report will contain details about the germination success, with a percentage indication, of the specified plant batch.</label>
                </div>


                <div class="columns">
                    <div class="col">
                        <h4>Select plant batch to generate the germination report for:</h4>
                    </div>
